...
def setup():
    ...
    test_utils.add_test_property(
        TEST_CLIENT._dbclient.PROPERTYSERVICE_TABLE, TEST_PROPERTY
    )
    test_utils.add_test_review(TEST_CLIENT._dbclient.PROPERTYSERVICE_TABLE, TEST_REVIEW)
...
class TestPostReviewService:
    ...
    def test_post_review_with_invalid_tenancy_dates(self):
        ...
        response = TEST_CLIENT.post_review(TEST_PROPERTY.itemId, invalid_review)
